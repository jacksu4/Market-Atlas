  ...
  useEffect(() => {
    ...
    if (errorParam) {
      const errorMessages: Record<string, string> = {
        ...
        no_email: "No email received from Google account.",
        email_linked_other_provider: "This email is linked to another provider.",
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            Enter your credentials to access Market Atlas
          </CardDescription>
        </CardHeader>
        <CardContent>
